...
public class TransferenciaCondutor extends javax.swing.JDialog {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(TransferenciaCondutor.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                TransferenciaCondutor dialog = new TransferenciaCondutor(new javax.swing.JFrame(), true);
